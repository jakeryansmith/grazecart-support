...
@section('page_header')
	<div class="pageHeader_container">
		<div class="pageHeader_innerContainer flex align-items-m">
			...
			<div class="flex-item">
				<div class="fs-5 bold mb-sm">GrazeCart Guides</div>
				<div class="fs-normal text-primary-9 lh-4 ml-xs">Step by step guides for becoming a GrazeCart expert</div>
			</div>	
		</div>
	</div>	
@stop
			...
			@foreach($guides as $guide)
				<a href="{{ url('/guides/'.$guide->slug) }}">
					<div class="align-items-t">
						<div class="flex-item">
							<div class="text-gray fs-2 bold mb-xs lh-5">
								{{ $guide->title }}
							</div>
							<div class="lh-3 fs-1 text-gray-5 mb-md lh-2">
								{{ $guide->description }}
							</div>
